...
import { transmissionFor, type TransmissionChoice } from "@/game/transmissions";

export function TransmissionsPanel({ craft, onChoice }: { craft: Craft | null; onChoice: (pingId: string, choice: TransmissionChoice) => void }) {
